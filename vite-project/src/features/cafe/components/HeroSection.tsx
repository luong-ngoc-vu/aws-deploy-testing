  ...
  return (
    <section className="relative isolate overflow-hidden" id="home" aria-labelledby="hero-heading">
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(90deg, rgba(28, 20, 14, 0.82), rgba(28, 20, 14, 0.42)), url('https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?auto=format&fit=crop&w=1800&q=80')",
        }}
      />
